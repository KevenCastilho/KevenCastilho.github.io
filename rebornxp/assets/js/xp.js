...
$(function() {
	...
	var temp = document.createElement('div');
	temp.innerHTML = `<window title="Sobre o RebornXP" width="418" height="328">
	<br>
	<center><h1>RebornXP</h1></center>
	<br>
	<p>&nbsp;&nbsp;RebornXP &copy; 2022 Keven Castilho</p>
...
$.fn.initWindows = function() {
	...
	<div class="ui_desktop" id="_ui_desktop">
		<div tabindex="0" data-exe="openLocation('Meu Computador')" data-target="Meu Computador" class="ui_icon" style="position:absolute;left:0px;top:0px;">
	...
	<taskbar id="_ui_taskbar" class="shadow" onmousedown="return false;" oncontextmenu="return false;">
		...
		<div class="startmenu_middle">
			...
			<li class="startmenuitem" onclick="openLocation('/Documents and Settings/' + xp.profile.name + '/Meus Documentos')">
			...
			<li class="startmenuitem">
				...
				<div><div>
				<b>Documentos Recentes</b>
				</div></div>
			</li>
			<li class="startmenuitem" onclick="openLocation('/Documents and Settings/' + xp.profile.name + '/Meus Documentos/Minhas Imagens')">
				<img src="` + xp.startmenu.icons.pictures + `"/>
				<div><div>
				<b>Minhas Imagens</b>
				</div></div>
			</li>
			<li class="startmenuitem" onclick="openLocation('/Documents and Settings/' + xp.profile.name + '/Meus Documentos/Minhas Musicas')">
				<img src="` + xp.startmenu.icons.music + `"/>
				<div><div>
				<b>Minhas Musicas</b>
				</div></div>
			</li>
			<li class="startmenuitem" onclick="openLocation('Meu Computador')">
			...
			<li class="startmenuitem" onclick="openLocation('Painel de Controle')">
			...
			<li class="startmenuitem" onclick="">
				<img src="` + xp.startmenu.icons.controlpanel + `"/>
				<div><div>
				<b>Impressoras e Fax</b>
				</div></div>
			</li>
			<li class="startmenuseparator"></li>


			<!--Procurar is under Development-->
			<li class="startmenuitem" onclick="">
				<img src="` + xp.startmenu.icons.Procurar + `"/>
				<div><div>
				<b>Procurar</b>
				</div></div>
			</li>
