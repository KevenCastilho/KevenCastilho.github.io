	...
	Dropzone = function (e) {
		function t(e, i) {
			...
			if (n.options = t.extend({}, n.defaultOptions, a, null != i ? i : {}), n.options.forceFallback || !t.isBrowserSupported()) {
				var s;
				return s = n.options.fallback.call(n), _possibleConstructorReturn(n, s)
			}
			...
			}), n.options.method = n.options.method.toUpperCase(), (r = n.getExistingFallback()) && r.parentNode && r.parentNode.removeChild(r), !1 !== n.options.previewsContainer && (n.options.previewsContainer ? n.previewsContainer = t.getElement(n.options.previewsContainer, "previewsContainer") : n.previewsContainer = n.element), n.options.clickable && (!0 === n.options.clickable ? n.clickableElements = [n.element] : n.clickableElements = t.getElements(n.options.clickable, "clickable")), n.init(), n
		}
		return _inherits(t, e), _createClass(t, null, [{
				...
				this.prototype.Emitter = Emitter, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
					...
					addedfile: function (e) {
						...
						if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
							...
							for (var s = 0, l = l = e.previewElement.querySelectorAll("[data-dz-size]"); !(s >= l.length);)(a = l[s++]).innerHTML = this.filesize(e.size);
							...
							for (var u = 0, d = d = e.previewElement.querySelectorAll("[data-dz-remove]"); ;) {
								if (u >= d.length) break;
								d[u++].addEventListener("click", function (n) {
			...
			value: function () {
				var e = this;
				if ("form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"), this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message"), this.clickableElements.length) {
					! function t() {
				...
				return this.listeners = [{
					...
					events: {
						...
						dragover: function (t) {
							...
							return t.dataTransfer.dropEffect = "move" === i || "linkMove" === i ? "move" : "copy", a(t), e.emit("dragover", t)
						},
			...
			value: function (e, t, i, n, r, o) {
				...
				return s.onload = function () {
					e.dataURL = s.result; {
						if ("image/svg+xml" !== e.type) return a.createThumbnailFromUrl(e, t, i, n, r, o);
						null != o && o(s.result)
					}
				}, s.readAsDataURL(e)
			}
					...
					if (e[0].upload.chunked) {
						...
						if (r.upload.finishedChunkUpload = function (n) {
							...
							for (var a = 0; a < r.upload.totalChunkCount; a++) {
								if (void 0 === r.upload.chunks[a]) return s();
						...
						for (var u = [], d = 0; d < e.length; d++) u[d] = {
			...
			value: function (e) {
				if ("FORM" === this.element.tagName)
					for (var t = 0, i = i = this.element.querySelectorAll("input, textarea, select, button"); ;) {
						...
						if (a && (a = a.toLowerCase()), void 0 !== o && null !== o)
							if ("SELECT" === r.tagName && r.hasAttribute("multiple"))
								for (var s = 0, l = l = r.options; ;) {
									var u;
									if (s >= l.length) break;
									var d = u = l[s++];
									d.selected && e.append(o, d.value)
								} else (!a || "checkbox" !== a && "radio" !== a || r.checked) && e.append(o, r.value)
					}
			}
		}, {
			...
			value: function (e, t, i) {
				...
				if (void 0 !== i) {
					...
					for (var v = 0, g = g = e; ;) {
						...
						if (v >= g.length) break;
						var y = k = g[v++];
						100 === y.upload.progress && y.upload.bytesSent === y.upload.total || (m = !1), y.upload.progress = n, y.upload.bytesSent = y.upload.total
					}
					if (m) return;
					for (var b = 0, F = F = e; ;) {
						var w;
			...
			value: function (e, i, n) {
				for (var r = 0, o = o = e; ;) {
					...
					if (r >= o.length) break;
					var s = a = o[r++];
					s.status = t.SUCCESS, this.emit("success", s, i, n), this.emit("complete", s)
				}
			...
			value: function (e, i, n) {
				for (var r = 0, o = o = e; ;) {
					...
					if (r >= o.length) break;
					var s = a = o[r++];
					s.status = t.ERROR, this.emit("error", s, i, n), this.emit("complete", s)
				}
...
Dropzone.initClass(), Dropzone.version = "5.2.0", Dropzone.options = {}, Dropzone.optionsForElement = function (e) {
...
var detectVerticalSquash = function (e) {
	...
	n.drawImage(e, 0, 0);
	for (var r = n.getImageData(1, 0, 1, t).data, o = 0, a = t, s = t; s > o;) 0 === r[4 * (s - 1) + 3] ? a = s : o = s, s = a + o >> 1;
	var l = s / t;
	return 0 === l ? 1 : l
},
	...
	ExifRestore = function () {
		...
		return _createClass(e, null, [{
			...
			key: "encode64",
			value: function (e) {
				for (var t = "", i = void 0, n = void 0, r = "", o = void 0, a = void 0, s = void 0, l = "", u = 0; ;)
					if (i = e[u++], n = e[u++], r = e[u++], o = i >> 2, a = (3 & i) << 4 | n >> 4, s = (15 & n) << 2 | r >> 6, l = 63 & r, isNaN(n) ? s = l = 64 : isNaN(r) && (l = 64), t = t + this.KEY_STR.charAt(o) + this.KEY_STR.charAt(a) + this.KEY_STR.charAt(s) + this.KEY_STR.charAt(l), i = n = r = "", o = a = s = l = "", !(u < e.length)) break;
				return t
			}
		}, {
			key: "restore",
			...
			value: function (e) {
				...
				for (/[^A-Za-z0-9\+\/\=]/g.exec(e) && console.warn("There were invalid base64 characters in the input text.\nValid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='\nExpect errors in decoding."), e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); ;)
					if (r = this.KEY_STR.indexOf(e.charAt(l++)), o = this.KEY_STR.indexOf(e.charAt(l++)), a = this.KEY_STR.indexOf(e.charAt(l++)), s = this.KEY_STR.indexOf(e.charAt(l++)), t = r << 2 | o >> 4, i = (15 & o) << 4 | a >> 2, n = (3 & a) << 6 | s, u.push(t), 64 !== a && u.push(i), 64 !== s && u.push(n), t = i = n = "", r = o = a = s = "", !(l < e.length)) break;
				return u
			}
		}]), e
	}();
